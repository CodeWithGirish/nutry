      ...
      <section className="bg-gradient-to-br from-brand-50 to-warm-50 py-12 sm:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <Badge className="bg-brand-100 text-brand-700 mb-4 sm:mb-6 text-sm sm:text-base">
              About NutriVault
            </Badge>
            ...
            {values.map((value, index) => (
              ...
              >
                <CardContent className="p-4 sm:p-6">
                  <div className="inline-flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-brand-100 text-brand-600 rounded-full mb-4 sm:mb-6">
            ...
            {team.map((member, index) => (
              ...
              >
                <CardContent className="p-4 sm:p-6">
                  ...
                  <p className="text-brand-600 font-medium mb-2 sm:mb-3 text-sm sm:text-base">
                    {member.role}
                  </p>
                  <p className="text-gray-600 text-sm sm:text-base">
                    {member.description}
